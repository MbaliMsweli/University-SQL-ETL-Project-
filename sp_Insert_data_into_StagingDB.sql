...
CREATE OR ALTER PROCEDURE dbo.sp_Load_Year1Modules_Staging
AS
BEGIN
    SET NOCOUNT ON;

    TRUNCATE TABLE dbo.Year1Modules;

    INSERT INTO dbo.Year1Modules (
        ModuleCode,
        ModuleName,
        Credits,
        Category
...
EXEC dbo.sp_Load_Year1Modules_Staging;
...
CREATE OR ALTER PROCEDURE dbo.sp_Load_Year2Modules_Staging
AS
BEGIN
    SET NOCOUNT ON;

    TRUNCATE TABLE dbo.Year2Modules;

    INSERT INTO dbo.Year2Modules (
        ModuleCode,
        ModuleName,
        Credits,
        Category
...
EXEC dbo.sp_Load_Year2Modules_Staging;
...
CREATE OR ALTER PROCEDURE dbo.sp_Load_Year3Modules_Staging
AS
BEGIN
    SET NOCOUNT ON;

    TRUNCATE TABLE dbo.Year3Modules;

    INSERT INTO dbo.Year3Modules (
        ModuleCode,
        ModuleName,
        Credits,
        Category
...
EXEC dbo.sp_Load_Year3Modules_Staging;
